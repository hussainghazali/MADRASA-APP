...
export const defaultMenuListAndEntitlements = [
    ...
    {
      pageId: 5, accessTypeId: 0, menu: { name: 'Qari', icon: 'person', modelUrl: 'employee' },
      subPage: [
        { 
          subPageId: 1, accessTypeId: 0, menu: { name: 'Qari List', url: 'empmgmt', icon: 'assignment_ind' } 
        }
      ]
    },
    {
    ...
    {
      pageId: 8, accessTypeId: 0, menu: { name: 'Madrasa', icon: 'domain', modelUrl: 'school' },
      subPage: [
        { 
        ...
        { 
          subPageId: 6, accessTypeId: 0, menu: { name: 'Madrasa Details', url: 'schoolmgmt', icon: 'business' } 
        }        
      ]
    },
    {
      pageId: 9, accessTypeId: 0, menu: { name: 'Assessment', icon: 'chrome_reader_mode', modelUrl: 'exam' },
      subPage: [        
        { 
          subPageId: 1, accessTypeId: 0, menu: { name: 'Assessment Management', url: 'exammgmt', icon: 'chrome_reader_mode' } 
        },
        { 
          subPageId: 2, accessTypeId: 0, menu: { name: 'Assessment Types', url: 'examtypemgmt', icon: 'developer_board' } 
        }
      ]
    },
